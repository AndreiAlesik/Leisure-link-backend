...
public record EventCreateDto(
    @Schema(description = "Name of the event", example = "Rock Concert") String name,
    ...
    @Schema(description = "Geographical longitude of the event location", example = "21.0122")
        Double longitude,
    @Schema(description = "list of categories") List<String> categories,
    @Schema(description = "Photo") List<MultipartFile> photos) {}
